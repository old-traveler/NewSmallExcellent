package com.hyc.newsmallexcellent.base.widger;
...
public class CommonDialog extends Dialog implements View.OnClickListener {
  ...
  public static void showDialog(Context context,String content,OnDialogClickListener listener){
    showDialog(context,"提示","取消","确定",content,listener);
  }

  public static void showDialog(Context context,String title,String neg,String pos,String content,OnDialogClickListener listener){
